...
def test_csv_to_sql_table():
	...
	assert csv_to_sql_table('testdata.csv') == "CREATE TABLE testdata (id int, name varchar(255), email varchar(255), date date(), info1 varchar(255), info2 varchar(255), info3 varchar(255));"
